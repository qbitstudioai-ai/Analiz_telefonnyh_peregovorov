...
begin
  ...
  where has_table_privilege(v_role, 'shablon_analiz_telefonnyh_peregovorov.analysis_versions', 'DELETE')
     or has_table_privilege(v_role, 'shablon_analiz_telefonnyh_peregovorov.business_confirmations', 'DELETE')
     or has_table_privilege(v_role, 'shablon_analiz_telefonnyh_peregovorov.delivery_attempts', 'DELETE')
     or has_table_privilege(v_role, 'shablon_analiz_telefonnyh_peregovorov.audit_events', 'DELETE');
