...
begin
  ...
  where to_regclass('shablon_analiz_telefonnyh_peregovorov.' || required.required_view) is null;
  ...
  -- PostgreSQL 17 may automatically grant each role created by the current
  -- non-superuser CREATEROLE operator back to that operator WITH ADMIN TRUE,
  -- SET FALSE, INHERIT FALSE. Those creator-admin memberships are required to
  -- administer/drop the roles and are automatically revoked by DROP ROLE.
  -- Refuse rollback only when some membership differs from that safe pattern.
  select string_agg(
  ...
  if v_memberships is not null then
    raise exception
      'DB-07 rollback refused: unexpected capability-role memberships exist: %',
      v_memberships;
  end if;
  ...
  if v_extra_relations is not null then
    raise exception
      'DB-07 rollback refused: later/unknown relations exist in shablon_analiz_telefonnyh_peregovorov: %',
      v_extra_relations;
  end if;
...
alter table shablon_analiz_telefonnyh_peregovorov.raw_transcripts disable row level security;
alter table shablon_analiz_telefonnyh_peregovorov.transcript_segments disable row level security;
alter table shablon_analiz_telefonnyh_peregovorov.pseudonym_mappings disable row level security;

drop function shablon_analiz_telefonnyh_peregovorov.admin_propose_correction(
  uuid, shablon_analiz_telefonnyh_peregovorov.correction_target_type, uuid, text, text, jsonb, jsonb, text, text, uuid
);
drop function shablon_analiz_telefonnyh_peregovorov.admin_submit_analysis_dispute(
  uuid, uuid, uuid, uuid, text, text
);

drop view shablon_analiz_telefonnyh_peregovorov.v_monitor_delivery;
drop view shablon_analiz_telefonnyh_peregovorov.v_monitor_audio_cleanup;
drop view shablon_analiz_telefonnyh_peregovorov.v_monitor_operations;
drop view shablon_analiz_telefonnyh_peregovorov.v_admin_audit_safe;
drop view shablon_analiz_telefonnyh_peregovorov.v_dashboard_feedback_safe;
drop view shablon_analiz_telefonnyh_peregovorov.v_dashboard_disputes_safe;
drop view shablon_analiz_telefonnyh_peregovorov.v_dashboard_corrections_safe;
drop view shablon_analiz_telefonnyh_peregovorov.v_dashboard_knowledge_evidence;
drop view shablon_analiz_telefonnyh_peregovorov.v_dashboard_evidence_absence;
drop view shablon_analiz_telefonnyh_peregovorov.v_dashboard_evidence_conversation;
drop view shablon_analiz_telefonnyh_peregovorov.v_dashboard_safe_transcript_segments;
drop view shablon_analiz_telefonnyh_peregovorov.v_dashboard_analysis_provenance;
drop view shablon_analiz_telefonnyh_peregovorov.v_runtime_knowledge_call_analysis;
drop view shablon_analiz_telefonnyh_peregovorov.v_runtime_filter_rules_active;
drop view shablon_analiz_telefonnyh_peregovorov.v_runtime_methodology_stages_active;
drop view shablon_analiz_telefonnyh_peregovorov.v_runtime_methodology_criteria_active;
drop view shablon_analiz_telefonnyh_peregovorov.v_runtime_methodology_active;
drop view shablon_analiz_telefonnyh_peregovorov.v_runtime_prompt_active;

-- Remove all grants made to the capability roles.
revoke all privileges on all tables in schema shablon_analiz_telefonnyh_peregovorov from
  shablon_analiz_telefonnyh_peregovorov_orchestrator,
  shablon_analiz_telefonnyh_peregovorov_core,
  shablon_analiz_telefonnyh_peregovorov_privacy,
  shablon_analiz_telefonnyh_peregovorov_raw_transcript_reader,
...
revoke all privileges on all sequences in schema shablon_analiz_telefonnyh_peregovorov from
  shablon_analiz_telefonnyh_peregovorov_orchestrator,
  shablon_analiz_telefonnyh_peregovorov_core,
  shablon_analiz_telefonnyh_peregovorov_privacy,
  shablon_analiz_telefonnyh_peregovorov_raw_transcript_reader,
...
revoke all privileges on all functions in schema shablon_analiz_telefonnyh_peregovorov from
  shablon_analiz_telefonnyh_peregovorov_orchestrator,
  shablon_analiz_telefonnyh_peregovorov_core,
  shablon_analiz_telefonnyh_peregovorov_privacy,
  shablon_analiz_telefonnyh_peregovorov_raw_transcript_reader,
...
revoke all privileges on schema shablon_analiz_telefonnyh_peregovorov from
  shablon_analiz_telefonnyh_peregovorov_orchestrator,
  shablon_analiz_telefonnyh_peregovorov_core,
  shablon_analiz_telefonnyh_peregovorov_privacy,
  shablon_analiz_telefonnyh_peregovorov_raw_transcript_reader,
...
grant execute on all functions in schema shablon_analiz_telefonnyh_peregovorov to public;
alter default privileges in schema shablon_analiz_telefonnyh_peregovorov
  grant execute on functions to public;

drop role shablon_analiz_telefonnyh_peregovorov_monitor;
drop role shablon_analiz_telefonnyh_peregovorov_admin_api;
drop role shablon_analiz_telefonnyh_peregovorov_dashboard;
drop role shablon_analiz_telefonnyh_peregovorov_knowledge_admin;
drop role shablon_analiz_telefonnyh_peregovorov_knowledge_reader;
drop role shablon_analiz_telefonnyh_peregovorov_raw_transcript_reader;
drop role shablon_analiz_telefonnyh_peregovorov_privacy;
drop role shablon_analiz_telefonnyh_peregovorov_core;
drop role shablon_analiz_telefonnyh_peregovorov_orchestrator;
