...
begin
  ...
  begin
    insert into shablon_analiz_telefonnyh_peregovorov.prompt_versions (
      family_ref,
      version_no,
      prompt_text,
      content_sha256,
  ...
  update shablon_analiz_telefonnyh_peregovorov.prompt_versions
  set
  ...
  insert into shablon_analiz_telefonnyh_peregovorov.methodology_versions (
    family_ref,
    version_no,
    title,
    scoring_config,
  ...
  insert into shablon_analiz_telefonnyh_peregovorov.methodology_criteria (
  ...
  insert into shablon_analiz_telefonnyh_peregovorov.methodology_stages (
    methodology_version_id,
    stage_code,
    display_name,
    sort_order,
  ...
  update shablon_analiz_telefonnyh_peregovorov.methodology_versions
  set
    validation_status = 'passed',
    config_state = 'ready'
  ...
  begin
    update shablon_analiz_telefonnyh_peregovorov.methodology_criteria
    set weight = 2
    where methodology_version_id = v_methodology_id
  ...
  insert into shablon_analiz_telefonnyh_peregovorov.filter_rule_versions (
    family_ref,
    version_no,
    rules_json,
    content_sha256,
  ...
  update shablon_analiz_telefonnyh_peregovorov.filter_rule_versions
  set
    validation_status = 'passed',
    config_state = 'active',
    activated_at = now()
  ...
  insert into shablon_analiz_telefonnyh_peregovorov.knowledge_documents (
    stable_code,
    title,
    source_type,
    source_ref
  ...
  insert into shablon_analiz_telefonnyh_peregovorov.knowledge_document_versions (
    document_id,
    version_no,
    source_version_ref,
    content,
  ...
  update shablon_analiz_telefonnyh_peregovorov.knowledge_document_versions
  set
    validation_status = 'passed',
  ...
  insert into shablon_analiz_telefonnyh_peregovorov.knowledge_fragments (
    document_id,
    document_version_id,
    fragment_family_key,
    fragment_version_no,
  ...
  insert into shablon_analiz_telefonnyh_peregovorov.knowledge_embeddings (
    fragment_id,
    version_no,
    provider,
    model_name,
  ...
  insert into shablon_analiz_telefonnyh_peregovorov.knowledge_publications (
    family_ref,
    version_no,
    publication_state,
    validation_status,
  ...
  insert into shablon_analiz_telefonnyh_peregovorov.knowledge_publication_documents (
    publication_id,
    document_version_id,
    document_id,
    document_order
  ...
  insert into shablon_analiz_telefonnyh_peregovorov.knowledge_publication_fragments (
    publication_id,
    fragment_id,
    document_version_id,
    document_id,
  ...
  insert into shablon_analiz_telefonnyh_peregovorov.knowledge_publication_fragment_products (
    publication_id,
    fragment_id,
    product_code
  )
  ...
  select count(*)
  into v_view_rows
  from shablon_analiz_telefonnyh_peregovorov.v_runtime_knowledge_fragments
  ...
  update shablon_analiz_telefonnyh_peregovorov.knowledge_publications
  set
    validation_status = 'passed',
